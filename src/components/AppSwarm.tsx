...
function AppSwarm() {
    ...
    const handleSelectPostageStamp = (event: React.ChangeEvent<HTMLInputElement>) => {
        setSelectedPostageStamp(event.target.value as Address);
    };
        ...
        <div className="App">
            ...
            <code>
                ...
                {postageStamps.map(({ batchID, utilization }) => (
                    ...
                    >
                        <div>
                            <input type="radio" name="stamps" value={batchID} onChange={handleSelectPostageStamp} />
                        </div>
                        <div>{batchID}</div>
                        <div>{utilization}</div>
                    </div>
